...
polydown textures --maps Diffuse Roughness
...
polydown models -f downs -s 1k -tf png --maps Diffuse -no
```
...
| `--maps`                  | List of texture maps to download (e.g., `Diffuse`, `Roughness`, `nor_gl`). |
